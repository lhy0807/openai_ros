...
'''
class StretchEnv(robot_gazebo_env.RobotGazeboEnv):

    '''
    DESCRIPTION: TODO...
        Initializes a new StretchEnv environment.
        ...
        Sensor Topic List:
        * /stretch_diff_drive_controller/odom: Odometry readings of the Base of the Robot
        * /camera/depth/color/image_raw: 2d Depth image of the depth sensor.
        * /camera/depth/color/points: Pointcloud sensor readings
        * /camera/rgb/image_raw: RGB camera
        * /scan: Laser Readings
        
        Actuators Topic List: /stretch_diff_drive_controller/cmd_vel
    ...
    def __init__(self, robot_namespace="", initial_pose={}, data_folder_path="", velocity_control_msg=""):
        ...
        rospy.logdebug("stretch_env::__init__ -> START...")
        ...
        super(StretchEnv, self).__init__(controllers_list=self.controllers_list,
        ...
        rospy.Subscriber("/stretch_diff_drive_controller/odom", Odometry, self._odom_callback)
        ...
        rospy.logdebug("stretch_env::__init__ -> END")
    ...
    def _check_all_sensors_ready(self):
        ...
        rospy.logdebug("stretch_env::_check_all_sensors_ready -> START...")
        ...
        rospy.logdebug("stretch_env::_check_all_sensors_ready -> END")
    ...
    def _check_odom_ready(self):
        ...
        self.odom = None
        rospy.logdebug("stretch_env::_check_odom_ready -> Waiting for /" + str(self.robot_namespace) + "/odom to be READY...")
        while self.odom is None and not rospy.is_shutdown():
            try:
                self.odom = rospy.wait_for_message("/stretch_diff_drive_controller/odom", Odometry, timeout=1.0)
                rospy.logdebug("stretch_env::_check_odom_ready -> Current /" + str(self.robot_namespace) + "/odom READY!")

            except:
                rospy.logerr("stretch_env::_check_odom_ready -> Current /" + str(self.robot_namespace) + "/odom not ready yet, retrying...")
    ...
    def _check_imu_ready(self):
        ...
        self.imu = None
        rospy.logdebug("stretch_env::_check_imu_ready -> Waiting for /" + str(self.robot_namespace) + "/imu to be READY...")
        while self.imu is None and not rospy.is_shutdown():
            try:
                self.imu = rospy.wait_for_message("/imu/data", Imu, timeout=1.0)
                rospy.logdebug("stretch_env::_check_imu_ready -> Current /" + str(self.robot_namespace) + "/imu READY!")

            except:
                rospy.logerr("stretch_env::_check_imu_ready -> Current /" + str(self.robot_namespace) + "/imu not ready yet, retrying...")
    ...
    def _check_laser_scan_ready(self):
        ...
        rospy.logdebug("stretch_env::_check_laser_scan_ready -> Waiting for /" + str(self.robot_namespace) + "/scan to be READY...")
        while self.laser_scan is None and not rospy.is_shutdown():
            try:
                self.laser_scan = rospy.wait_for_message("/scan", LaserScan, timeout=1.0)
                rospy.logdebug("stretch_env::_check_laser_scan_ready -> Current /" + str(self.robot_namespace) + "/scan READY!")

            except:
                rospy.logerr("stretch_env::_check_laser_scan_ready -> Current /" + str(self.robot_namespace) + "/scan not ready yet, retrying...")
    ...
    def _check_camera_depth_image_raw_ready(self):
        ...
        rospy.logdebug("stretch_env::_check_camera_depth_image_raw_ready -> Waiting for /" + str(self.robot_namespace) + "/camera/depth/image_raw to be READY...")
        while self.camera_depth_image_raw is None and not rospy.is_shutdown():
            try:
                ...
                rospy.logdebug("stretch_env::_check_camera_depth_image_raw_ready -> Current /" + str(self.robot_namespace) + "/camera/depth/image_raw READY!")

            except:
                rospy.logerr("stretch_env::_check_camera_depth_image_raw_ready -> Current /" + str(self.robot_namespace) + "/camera/depth/image_raw not ready yet, retrying...")
    ...
    def _check_camera_depth_points_ready(self):
        ...
        rospy.logdebug("stretch_env::_check_camera_depth_points_ready -> Waiting for /" + str(self.robot_namespace) + "/camera/depth/points to be READY...")
        while self.camera_depth_points is None and not rospy.is_shutdown():
            try:
                self.camera_depth_points = rospy.wait_for_message("/camera/depth/color/points", PointCloud2, timeout=5.0)
                rospy.logdebug("stretch_env::_check_camera_depth_points_ready -> Current /" + str(self.robot_namespace) + "/camera/depth/points READY!")

            except:
                rospy.logerr("stretch_env::_check_camera_depth_points_ready -> Current /" + str(self.robot_namespace) + "/camera/depth/points not ready yet, retrying...")
    ...
    def _check_camera_rgb_image_raw_ready(self):
        ...
        rospy.logdebug("stretch_env::_check_camera_rgb_image_raw_ready -> Waiting for /" + str(self.robot_namespace) + "/camera/rgb/image_raw to be READY...")
        while self.camera_rgb_image_raw is None and not rospy.is_shutdown():
            try:
                ...
                rospy.logdebug("stretch_env::_check_camera_rgb_image_raw_ready -> Current /" + str(self.robot_namespace) + "/camera/rgb/image_raw READY!")

            except:
                rospy.logerr("stretch_env::_check_camera_rgb_image_raw_ready -> Current /" + str(self.robot_namespace) + "/camera/rgb/image_raw not ready yet, retrying...")
    ...
    def _check_publishers_connection(self):
        ...
        while self._cmd_vel_pub.get_num_connections() == 0 and not rospy.is_shutdown():
            rospy.logdebug("stretch_env::_check_publishers_connection -> No subscribers to cmd_vel_pub yet so we wait and try again")
            try:
                rate.sleep()
            except rospy.ROSInterruptException:
                # This is to avoid error when world is rested, time when backwards.
                pass
        rospy.logdebug("stretch_env::_check_publishers_connection -> cmd_vel_pub Publisher Connected")
        rospy.logdebug("stretch_env::_check_publishers_connection -> All Publishers READY")
    ...
    def move_base(self, linear_speed, angular_speed, epsilon=0.05, update_rate=10):
        ...
        rospy.logdebug("stretch_env::move_base -> cmd_vel_value: " + str(cmd_vel_value))
    ...
    def update_initial_pose(self, initial_pose):
        ...
        self.initial_pose = initial_pose
        super(StretchEnv, self).update_initial_pose(self.initial_pose)
