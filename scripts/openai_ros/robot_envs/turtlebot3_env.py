...
class TurtleBot3Env(robot_gazebo_env.RobotGazeboEnv):
    ...
    def _check_odom_ready(self):
        ...
        self.odom = None
        rospy.logdebug("turtlebot3_env::_check_odom_ready -> Waiting for /" + str(self.robot_namespace) + "/odom to be READY...")
        while self.odom is None and not rospy.is_shutdown():
            try:
                self.odom = rospy.wait_for_message("/" + str(self.robot_namespace) + "/odom", Odometry, timeout=1.0)
                rospy.logdebug("turtlebot3_env::_check_odom_ready -> Current /" + str(self.robot_namespace) + "/odom READY!")

            except:
                rospy.logerr("turtlebot3_env::_check_odom_ready -> Current /" + str(self.robot_namespace) + "/odom not ready yet, retrying...")
    ...
    def _check_imu_ready(self):
        ...
        self.imu = None
        rospy.logdebug("turtlebot3_env::_check_imu_ready -> Waiting for /" + str(self.robot_namespace) + "/imu to be READY...")
        while self.imu is None and not rospy.is_shutdown():
            try:
                ...
                rospy.logdebug("turtlebot3_env::_check_imu_ready -> Current /" + str(self.robot_namespace) + "/imu READY!")

            except:
                rospy.logerr("turtlebot3_env::_check_imu_ready -> Current /" + str(self.robot_namespace) + "/imu not ready yet, retrying...")
    ...
    def _check_laser_scan_ready(self):
        ...
        rospy.logdebug("turtlebot3_env::_check_laser_scan_ready -> Waiting for /" + str(self.robot_namespace) + "/scan to be READY...")
        while self.laser_scan is None and not rospy.is_shutdown():
            try:
                self.laser_scan = rospy.wait_for_message("/" + str(self.robot_namespace) + "/scan", LaserScan, timeout=1.0)
                rospy.logdebug("turtlebot3_env::_check_laser_scan_ready -> Current /" + str(self.robot_namespace) + "/scan READY!")

            except:
                rospy.logerr("turtlebot3_env::_check_laser_scan_ready -> Current /" + str(self.robot_namespace) + "/scan not ready yet, retrying...")
    ...
    def _check_camera_depth_image_raw_ready(self):
        ...
        rospy.logdebug("turtlebot3_env::_check_camera_depth_image_raw_ready -> Waiting for /" + str(self.robot_namespace) + "/camera/depth/image_raw to be READY...")
        while self.camera_depth_image_raw is None and not rospy.is_shutdown():
            try:
                ...
                rospy.logdebug("turtlebot3_env::_check_camera_depth_image_raw_ready -> Current /" + str(self.robot_namespace) + "/camera/depth/image_raw READY!")

            except:
                rospy.logerr("turtlebot3_env::_check_camera_depth_image_raw_ready -> Current /" + str(self.robot_namespace) + "/camera/depth/image_raw not ready yet, retrying...")
    ...
    def _check_camera_depth_points_ready(self):
        ...
        rospy.logdebug("turtlebot3_env::_check_camera_depth_points_ready -> Waiting for /" + str(self.robot_namespace) + "/camera/depth/points to be READY...")
        while self.camera_depth_points is None and not rospy.is_shutdown():
            try:
                ...
                rospy.logdebug("turtlebot3_env::_check_camera_depth_points_ready -> Current /" + str(self.robot_namespace) + "/camera/depth/points READY!")

            except:
                rospy.logerr("turtlebot3_env::_check_camera_depth_points_ready -> Current /" + str(self.robot_namespace) + "/camera/depth/points not ready yet, retrying...")
    ...
    def _check_camera_rgb_image_raw_ready(self):
        ...
        rospy.logdebug("turtlebot3_env::_check_camera_rgb_image_raw_ready -> Waiting for /" + str(self.robot_namespace) + "/camera/rgb/image_raw to be READY...")
        while self.camera_rgb_image_raw is None and not rospy.is_shutdown():
            try:
                ...
                rospy.logdebug("turtlebot3_env::_check_camera_rgb_image_raw_ready -> Current /" + str(self.robot_namespace) + "/camera/rgb/image_raw READY!")

            except:
                rospy.logerr("turtlebot3_env::_check_camera_rgb_image_raw_ready -> Current /" + str(self.robot_namespace) + "/camera/rgb/image_raw not ready yet, retrying...")
