...
from tentabot_drl_config_turtlebot3 import *
...
class TurtleBot3TentabotDRL(turtlebot3_env.TurtleBot3Env):
    ...
    def __init__(self, robot_id=0, data_folder_path=""):
        ...
        # Publishers
        self.goal_reaching_status_pub = rospy.Publisher('/turtlebot' + str(robot_id) + '/goal_reaching_status', Bool, queue_size=1)
        self.goal_visu_pub = rospy.Publisher('/turtlebot' + str(robot_id) + '/goal', MarkerArray, queue_size=1)
        self.filtered_laser_pub = rospy.Publisher('/turtlebot' + str(robot_id) + '/laser/scan_filtered', LaserScan, queue_size=1)
    ...
    def _init_env_variables(self):
        ...
        print("--------------")
        print("turtlebot3_tentabot_drl::_init_env_variables -> self.robot_id: {}".format(self.robot_id))
        print("turtlebot3_tentabot_drl::_init_env_variables -> self.step_num: {}".format(self.step_num))
        print("turtlebot3_tentabot_drl::_init_env_variables -> self.total_step_num: {}".format(self.total_step_num))
        print("turtlebot3_tentabot_drl::_init_env_variables -> self.episode_num: {}".format(self.episode_num))
        print("turtlebot3_tentabot_drl::_init_env_variables -> self.total_collisions: {}".format(self.total_collisions))
        print("turtlebot3_tentabot_drl::_init_env_variables -> self.episode_reward: {}".format(self.episode_reward))
        print("turtlebot3_tentabot_drl::_init_env_variables -> self.total_mean_episode_reward: {}".format(self.total_mean_episode_reward))
        print("--------------")
    ...
    def _compute_reward(self, observations, done):
        ...
        if self._episode_done and (not self._reached_goal):
            ...
            print("turtlebot3_tentabot_drl::_compute_reward -> reward_goal: " + str(reward_goal))
            print("turtlebot3_tentabot_drl::_compute_reward -> penalty_safety: " + str(penalty_safety))
            print("turtlebot3_tentabot_drl::_compute_reward -> reward: " + str(reward))
            print("----------------------")
            '''
            
        self.episode_reward += reward
        
        rospy.logdebug("turtlebot3_tentabot_drl::_compute_reward -> reward: " + str(reward))
        rospy.logdebug("turtlebot3_tentabot_drl::_compute_reward -> self.episode_reward: " + str(self.episode_reward))
        rospy.logdebug("turtlebot3_tentabot_drl::_compute_reward -> self.total_step_num: " + str(self.total_step_num))
